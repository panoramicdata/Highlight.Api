...
/// </summary>
public class WirelessAccessPointHealth
{
	/// <summary>
	...
	/// <summary>
	/// The percent of errors (not applicable for WAP, will be zero or null).
	/// </summary>
	...
	/// <summary>
	/// The percent of site load in (not applicable for WAP, will be zero or null).
	/// </summary>
	[JsonPropertyName("siteLdInPc")]
	public required float? SiteLoadInPercent { get; set; }

	/// <summary>
	/// The percent of site load out (not applicable for WAP, will be zero or null).
	/// </summary>
